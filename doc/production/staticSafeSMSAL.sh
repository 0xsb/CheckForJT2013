...
export CLASSPATH
nohup java -Xms256m -Xmx1024m -XX:PermSize=128M -XX:MaxPermSize=256m  -Djava.awt.headless=true -classpath $CLASSPATH com.ailk.jt.staticfile.DeviceSubAcctLoginFile &