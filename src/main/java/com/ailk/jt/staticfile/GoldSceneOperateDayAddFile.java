...
@Deprecated
public class GoldSceneOperateDayAddFile {
	// 公共使用的属性
	...
	private static void replaceJKR() {
		try {
			File safeFileNameSMJKR = new File(dayFilePath + osflag
					+ "SMJKR_371_01DY_20120903_000_000.xml");
			String rightFileStr = "SMJKR.xml";
			OperateFile.copyFile(safeFileNameSMJKR, new File(uploadPath
					+ osflag + rightFileStr));
