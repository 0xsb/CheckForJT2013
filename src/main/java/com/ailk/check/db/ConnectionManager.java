...
public class ConnectionManager {
     ...
     * @param type 数据库类型
     */
    ConnectionManager(ConnectionFactory.Type type) {
        this.type = type;
    }
    ...
    public Connection getConnection() throws SQLException {
        ...
        if (connection == null) {
            if (dataSource != null) {
                ...
                connection = getConnectionByType(type);
            }
     ...
     * @return 数据库链接
     */
    private Connection getConnectionByType(ConnectionFactory.Type type) {
        Connection connection = null;
        switch (type) {
            case aiuap20:
                connection = DBUtil.getAiuap20Connection();
                break;
            case audit:
                connection = DBUtil.getAuditConnection();
                break;
        }
        return connection;
    }
